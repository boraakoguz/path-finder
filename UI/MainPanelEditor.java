...
public class MainPanelEditor extends JPanel {
    ...
    public MainPanelEditor(Controller backendController,Path_Finder_Frame m) {
        ...
        this.backendController.setDrawPanelEditor(drawPanel);
    ...
    public ToolsPanelEditor getToolsPanel() {
        return toolsPanel;
    }

    public LeftScreenPanelEditor getLeftScreenPanel() {
    ...
    public void blueBack() {
        ...
        backendController.setCurrentDrawContextEditor(backendController.getCurrentDrawContextEditor().getParent());
    }
    ...
    public void addFloor() {
        ...
        arrangeCursor(DRAW_ACTION);
        Building currentBuilding = (Building)backendController.getCurrentDrawContextEditor();
    ...
    public void delete() {
        ...
        Space parentSpace = backendController.getCurrentDrawContextEditor().getParent();
        if(parentSpace != null) {
            ...
            if(chooice == JOptionPane.YES_OPTION) {
                backendController.deleteSpace(backendController.getCurrentDrawContextEditor());
                backendController.setCurrentDrawContextEditor(parentSpace);
            }
            //TODO: NEED REPAINT?
            drawPanel.repaint();
        }
